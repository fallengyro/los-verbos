(function () {
  ...
  var I18N = {
    es: {
      ...
      import_json_intro: "Pegá o subí un archivo JSON con verbos y/o palabras que sigan el formato de Índice Verbal. Nada se guarda hasta que confirmes la importación.",
    ...
    en: {
      ...
      import_json_intro: "Paste or upload a JSON file with verbs and/or words that follows Índice Verbal's format. Nothing is saved until you confirm the import.",
